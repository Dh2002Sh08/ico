              ...
              {icoStatus && (
                <div
                  className={`p-5 rounded-xl text-sm font-medium flex items-center gap-3 transition-all duration-300
                    ${icoStatus === "active" ? "bg-green-100 text-green-800 border-l-4 border-green-500" :
                      icoStatus === "expired" ? "bg-red-100 text-red-800 border-l-4 border-red-500" :
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      defaultValue=""
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 text-gray-900 transition-all duration-200"
                    >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div
                      className={`p-3 rounded-lg text-center text-center text-sm font-medium transition-all duration-200
